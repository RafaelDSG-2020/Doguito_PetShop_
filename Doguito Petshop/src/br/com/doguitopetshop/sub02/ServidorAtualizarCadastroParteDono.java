...
public class ServidorAtualizarCadastroParteDono {
    ...
    public ServidorAtualizarCadastroParteDono() throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {

        System.out.println("---- Iniciando Servidor - [ATUALIZAR CADASTRO DA PARTE DONO - 7002] -----");
        ...
        this.servidor = (SSLServerSocket) sslContext.getServerSocketFactory().createServerSocket(7002);
    ...
    public void rodar() throws IOException {
        ...
        while (this.estaRodando) {
            try {
                ...
                ThreadAtualizarCadastroParteDono threadAtualizarCadastroParteDono = new
                        ThreadAtualizarCadastroParteDono(threadPool, socket, this, contadorIdMensagem);
                threadPool.execute(threadAtualizarCadastroParteDono);
    ...
    public static void main (String[]args) throws Exception {
        ServidorAtualizarCadastroParteDono servidor = new ServidorAtualizarCadastroParteDono();
        servidor.rodar();
        servidor.parar();
        threadPool.shutdown();
