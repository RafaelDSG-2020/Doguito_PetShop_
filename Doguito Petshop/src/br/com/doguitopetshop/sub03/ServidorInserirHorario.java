...
public class ServidorInserirHorario{
    ...
    public ServidorInserirHorario() throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {

        System.out.println("---- Iniciando Servidor - [INSERIR HORÁRIO POR PARTE DO COLABORADOR - 7005] -----");
        ...
        this.servidor = (SSLServerSocket) sslContext.getServerSocketFactory().createServerSocket(7005);
    ...
    public void rodar() throws IOException {
        ...
        while (this.estaRodando) {
            try {
                ...
                ThreadInserirHorario threadInserirHorario = new ThreadInserirHorario(threadPool, socket, this,
                        contadorIdMensagem);
                threadPool.execute(threadInserirHorario);
    ...
    public static void main (String[]args) throws Exception {
        ServidorInserirHorario servidor = new ServidorInserirHorario();
        servidor.rodar();
        servidor.parar();
        threadPool.shutdown();
