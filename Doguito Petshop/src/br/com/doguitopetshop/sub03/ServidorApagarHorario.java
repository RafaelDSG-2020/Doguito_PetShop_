...
public class ServidorApagarHorario{
    ...
    public ServidorApagarHorario() throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {

        System.out.println("---- Iniciando Servidor - [APAGAR HORARIO " +
                "POR PARTE DO COLABORADOR - 7006] -----");
        ...
        this.servidor = (SSLServerSocket) sslContext.getServerSocketFactory().createServerSocket(7006);
    ...
    public void rodar() throws IOException {
        ...
        while (this.estaRodando) {
            try {
                ...
                ThreadApagarHorario threadApagarHorario =
                        new ThreadApagarHorario(threadPool, socket, this, contadorIdMensagem);
                threadPool.execute(threadApagarHorario);
    ...
    public static void main (String[]args) throws Exception {
        ServidorApagarHorario servidor = new ServidorApagarHorario();
        servidor.rodar();
        servidor.parar();
        threadPool.shutdown();
