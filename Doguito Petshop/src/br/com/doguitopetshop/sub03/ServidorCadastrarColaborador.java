...
public class ServidorCadastrarColaborador{
    ...
    public ServidorCadastrarColaborador() throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {

        System.out.println("---- Iniciando Servidor - [AREA DOS COLABORADORES - 7007] -----");
        ...
        this.servidor = (SSLServerSocket) sslContext.getServerSocketFactory().createServerSocket(7007);
    ...
    public void rodar() throws IOException {
        ...
        while (this.estaRodando) {
            try {
                ...
                ThreadCadastrarColaborador threadCadastrarColaborador = new ThreadCadastrarColaborador(threadPool
                        , socket, this, contadorIdMensagem);
                threadPool.execute(threadCadastrarColaborador);
    ...
    public static void main (String[]args) throws Exception {
        ServidorCadastrarColaborador servidor = new ServidorCadastrarColaborador();
        servidor.rodar();
        servidor.parar();
        threadPool.shutdown();
