...
public class ServidorAtualizarColaborador {
    ...
    public ServidorAtualizarColaborador() throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {

        System.out.println("---- Iniciando Servidor - [ATUALIZAR CADASTRO DA PARTE DONO - 7008] -----");
        ...
        this.servidor = (SSLServerSocket) sslContext.getServerSocketFactory().createServerSocket(7008);
    ...
    public void rodar() throws IOException {
        ...
        while (this.estaRodando) {
            try {
                ...
                ThreadAtualizarColaborador threadAtualizarColaborador = new
                        ThreadAtualizarColaborador(threadPool, socket, this, contadorIdMensagem);
                threadPool.execute(threadAtualizarColaborador);
    ...
    public static void main (String[]args) throws Exception {
        ServidorAtualizarColaborador servidor = new ServidorAtualizarColaborador();
        servidor.rodar();
        servidor.parar();
        threadPool.shutdown();
