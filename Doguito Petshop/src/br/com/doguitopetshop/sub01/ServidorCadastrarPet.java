...
public class ServidorCadastrarPet {
    ...
    public ServidorCadastrarPet() throws IOException, KeyStoreException, NoSuchAlgorithmException, CertificateException,
            UnrecoverableKeyException, KeyManagementException {

        System.out.println("---- Iniciando Servidor - [CADASTRAR PET - 7001] -----");
        ...
        this.servidor = (SSLServerSocket) sslContext.getServerSocketFactory().createServerSocket(7001);
    ...
    public void rodar() throws IOException {
        ...
        while (this.estaRodando) {
            try {
                ...
                ThreadCadastrarPet threadCadastrarPet = new ThreadCadastrarPet(threadPool, socket,
                        this, contadorIdMensagem);
                threadPool.execute(threadCadastrarPet);
    ...
    public void parar() throws IOException {
        estaRodando = false;
        servidor.close();
        threadPool.shutdown(); // Espera todos os clientes terminarem
    }

    public static void main(String[] args) throws Exception {
        ServidorCadastrarPet servidor = new ServidorCadastrarPet();
        servidor.rodar();
        servidor.parar();
        threadPool.shutdown();
    }
